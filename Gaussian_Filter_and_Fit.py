...
def main():
    Data = os.listdir('Data Y-Achse')
    y_result = []
    z_result = []
    for i in range(0,len(Data),3):
    #for i in range(0,9,3):
        file_path1 = os.path.join("Data Y-Achse",Data[i])
        file_path2 = os.path.join("Data Y-Achse",Data[i+1])
        file_path3 = os.path.join("Data Y-Achse",Data[i+2])
